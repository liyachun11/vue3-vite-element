...
/**
 * 全局设置请求头
 * 项目内涉及微服务请在每个api文件内设置微服务的请求头并在替换地址后添加微服务的区分地址
 * 例：etc数据稽查项目数据稽查微服务的请求头设置
 * axios.ETC_DATAAUDIT(这里的请求头名称根据微服务进行变化)_API = '/api/etcaudit/dataaudit'
 */

axios.MSG_BASE_CENTER = `${process.env.VITE_API_DOMAIN}/message`; //消息中心
